...
export default function SideNavbar() {
  ...
  <Link to="/admin-brands" className="list-group-item list-group-item-action">Brand</Link>
  <Link to="/admin-products" className="list-group-item list-group-item-action">Products</Link>
  <Link to="/admin-contacts" className="list-group-item list-group-item-action">Contact us</Link>
  <Link to="/admin-checkouts" className="list-group-item list-group-item-action">Checkout</Link>
  <Link to="/admin-newslatters" className="list-group-item list-group-item-action">Newsletters</Link>
