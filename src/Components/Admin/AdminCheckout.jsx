...
export default function AdminCheckout() {
    ...
    const columns = [
        ...
        { field: 'subtotal', headerName: 'Sub Total', width: 90,renderCell:({row})=><p>&#8377;{row.subtotal}</p> },
        { field: 'shipping', headerName: 'Shipping', width: 90,renderCell:({row})=><p>&#8377;{row.shipping}</p> },
        { field: 'total', headerName: 'Total', width: 90,renderCell:({row})=><p>&#8377;{row.total}</p> },
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-9 col-12">
                        <h5 className='bg-primary text-center p-2'>Checkouts</h5>
