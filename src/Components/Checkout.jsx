                    ...
                    <div className="col-lg-7">
                        ...
                        <div className="mb-5">
                            ...
                            <div className="bg-light p-30">
                                ...
                                <div className="form-group">
                                    <div className="custom-control custom-radio">
                                        <input  disabled type="radio" className="custom-control-input" onChange={getMode} name="mode" id="net-banking" />
                                        <label className="custom-control-label" for="net-banking">Net Banking/Card/UPI</label>
                                    </div>
                                </div>
