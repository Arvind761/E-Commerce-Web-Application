                ...
                <div className="row px-xl-5">
                    ...
                    <div className="col-lg-4">
                        <div className="product-offer mb-30" style={{ height: "200px" }}>
                            <img className="img-fluid" src="/assets/img/pic4.jpg" alt="" />
                        ...
                        <div className="product-offer mb-30" style={{ height: "200px" }}>
                            <img className="img-fluid" src="/assets/img/pic3.jpg" alt="" />
                            <div className="offer-text">
                                <h6 className="text-white text-uppercase">Save Upto 90%</h6>
                                <h3 className="text-white mb-3">Special Offer</h3>
                                <Link to="/shop/All/All/All" className="btn btn-primary">Shop Now</Link>
                                ...
                                <div className="product-item bg-light mb-4">
                                    <div className="product-img position-relative overflow-hidden">
                                        ...
                                        <div className="product-action">
                                            <Link to={`/single-product/${item.id}`} className="btn btn-outline-dark btn-square w-100" href="">View</Link>
                                        </div>
                                    </div>
