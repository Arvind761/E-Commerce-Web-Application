                ...
                <div className="row px-xl-5">
                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner bg-light">
                                <div className="carousel-item active">
                                    <img className="" src={`/assets/images/${product.pic1}`} style={{ height: "500px", width: "100%" }} alt="Image" />
                                </div>
                                <div className="carousel-item">
                                    <img className="" src={`/assets/images/${product.pic2}`} style={{ height: "500px", width: "100%" }} alt="Image" />
                                </div>
                                <div className="carousel-item">
                                    <img className="" src={`/assets/images/${product.pic3}`} style={{ height: "500px", width: "100%" }} alt="Image" />
                                </div>
                                <div className="carousel-item">
                                    <img className="" src={`/assets/images/${product.pic4}`} style={{ height: "500px", width: "100%" }} alt="Image" />
                                </div>
                            </div>
                    ...
                    <div className="col-lg-7 h-auto mb-30">
                        <div className="h-100 bg-light p-30">
                            <h5>{product.maincategory}/{product.subcategory}/{product.brand}</h5>
                            <h3>{product.name}</h3>
                            ...
                            <div className="d-flex align-items-center mb-4 pt-2">
...

                                {
                                    ...
                                    <button className="btn btn-primary px-3" ><i className="fa fa-shopping-cart mr-1"></i>only View the product</button>:
                                    <div>
                                <button className="btn btn-primary px-3" onClick={addToCart}><i className="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                                <button className="btn btn-danger px-3" onClick={addToWishlist}><i className="fa fa-heart mr-1"></i> Add To Wishlist</button>
                            </div>
                                }
