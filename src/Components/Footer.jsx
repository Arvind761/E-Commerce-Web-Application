...
export default function Footer() {
    ...
    function postData(e) {
        ...
        if (item){
            ...
            setShow(true)
            setMessage("Thank to Subscribe Our Newslatter Service!!! Our Team Will Contact You Soon !!!")
        }
    }
    function getAPIData() {
            ...
            <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
                <div className="row px-xl-5 pt-5">
                    <div className="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                        ...
                        <p className="mb-2"><i className="fa fa-envelope text-primary mr-3"></i><a href="mailto:arvindkumarjay07@gmail.com">arvindkumarjay07@gmail.com</a></p>
                        <p className="mb-0"><i className="fa fa-phone-alt text-primary mr-3"></i><a href="tel:9129479296">+91 9129479296</a></p>
                    </div>
