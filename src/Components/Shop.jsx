...
export default function Shop() {
    ...
    function filterData(mc, sc, br,priceFilter) {
        if (priceFilter === "None") {
            if (mc === 'All' && sc === 'All' && br === "All")
                ...
                setProduct(allProducts.slice(1).filter((x) => x.brand === br && x.subcategory === sc))
            else
            ...
            if (mc === 'All' && sc === 'All' && br === "All")
                ...
                setProduct(allProducts.slice(1).filter((x) => x.brand === br && x.subcategory === sc && x.finalprice>=min && x.finalprice<=max))
            else
    ...
    useEffect(getAPIData, [allMaincategories.length, allSubcategories.length, allBrands.length, allProducts.length])
    return (
        <>
                    ...
                    <div className="col-lg-3 col-md-4">
                        ...
                        <div className="bg-light p-4 mb-30">
                            <select name="price" onChange={getInputData} className='form-control'>
                                ...
                                <option value="sixth">&gt;&#8377;5001</option>
                            </select>
                        </div>
                    </div>
