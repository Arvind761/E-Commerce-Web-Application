            ...
            <div className="container-fluid">
                {
                    carts.length ?
                                    ...
                                    <tbody className="align-middle">
                                        {
                                            carts && carts.map((item, index) => {
                                                return <tr key={index}>
                                                    <td className="align-middle d-flex"><img src={`/assets/images/${item.pic}`} style={{ height: "50px", width: "50px" }} className='rounded' alt="" /> {item.name}</td>
                        ...
                        <div className='m-5 text-center' style={{fontSize:"35px"}}>No Items in Cart</div>
                }
            </div>
        </>
    )
